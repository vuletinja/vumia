...
<div class="navbar bg-primary">
    ...
    <div class="navbar-center">
      <a class="btn btn-ghost normal-case text-xl">vumia</a>
    </div>
...
<!--Footer koji sam skinuo sa daisyUI-->
...
<footer class="footer footer-center p-10 bg-primary text-primary-content">
  <aside>
    ...
    <p class="font-bold">
      Vumia Technologies DOO <br/>In the spare parts since 2018
    </p> 
    <p>Copyright © 2023 Vumia - All right reserved</p>
  </aside> 
  <nav>
