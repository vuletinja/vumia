...
<script>import { useThrelte, T, forwardEventHandlers } from '@threlte/core';
...
const makeGridMaterial = (axes) => {
    return new ShaderMaterial({
      ...
      void main() {
        ...
        float d = 1.0 - min(distance(cameraPosition.${axes.slice(0, 2)}, worldPosition.${axes.slice(0, 2)}) / uFadeDistance, 1.);
